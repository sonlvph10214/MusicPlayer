...
class PartyZingAdapter(var songList: MutableList<Song>, var context: Context) :
    RecyclerView.Adapter<PartyZingAdapter.AudioHolder>() {

    companion object{
        val URL_IMG ="https://photo-resize-zmp3.zmdcdn.me/w94_r1x1_webp/"
    }
    var onClickSong: ((Song, Int) -> Unit)? = null
    ...
    inner class AudioHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                val item = songList[layoutPosition]
